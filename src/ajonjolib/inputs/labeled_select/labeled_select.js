...
import styles from './labeled_select.module.css';

export default function LabeledSelect({ searchable, label, options, value, onChange, placeholder, className, style, disabled, multi, showQuantity }) {
    ...
    return (
        <div className={`${styles.container} ${className}`} ref={dropdownRef} style={style}>
            <div className={styles.label}>
                <div style={{color: '#8B8B8B', fontWeight: '600'}}>{label}</div>
            </div>
            <div
            ...
            >
                ...
                <div style={{ paddingLeft: '0.5rem' }}>
                    {isOpen ? <FontAwesomeIcon icon={faChevronUp} color={'#FFFFFF'}/> : <FontAwesomeIcon icon={faChevronDown} color={'#FFFFFF'} />}
                </div>
            </div>
                                ...
                                {multi && (
                                    <div className={`${styles.checkbox} ${
                                        ...
                                        {selectedOptionValues.includes(option.value) && (
                                            <div style={{
                                                backgroundColor: '#959595', borderRadius: '2px',
