...
export default function CurrencyList() {
    ...
    const cols = [
        ...
        {title: 'Symbol', internal: 'symbol'},
        {title: 'Rate', internal: 'conversion_rate'},
        ...
        {title: 'Actions', internal: 'id', code: (row, data) => {
                return (
                    <div className={'d-flex justify-content-end'}>
                        <div className={'pe-2'} style={{cursor: 'pointer'}} onClick={() => navigate('/currency/form', {state: row})}>
            ...
            {showDelete > 0 && <DeleteModal
                ...
                <div className={'d-flex justify-content-end align-items-center'}>
                    <Button
                        ...
                        variant={'danger'}
                        onClick={() => {
                            axiosInstance.delete('currency/' + showDelete + '/').then((response) => {
                                setShowDelete(0);
                                toast('Currency deleted', ToastTypes.SUCCESS);
