...
export default function SubcategoriesList() {
    ...
    const cols = [
        ...
        {title: 'Category', internal: 'category.name'},
        ...
        {title: 'Actions', internal: 'id', code: (row, data) => {
                return (
                    <div className={'d-flex justify-content-end'}>
                        <div className={'pe-2'} style={{cursor: 'pointer'}} onClick={() => navigate('/subcategories/form', {state: row})}>
            ...
            {showDelete > 0 && <DeleteModal
                ...
                <div className={'d-flex justify-content-end align-items-center'}>
                    <Button
                        ...
                        variant={'danger'}
                        onClick={() => {
                            axiosInstance.delete('subcategory/' + showDelete + '/').then((response) => {
                                setShowDelete(0);
                                toast('Subcategory deleted', ToastTypes.SUCCESS);
